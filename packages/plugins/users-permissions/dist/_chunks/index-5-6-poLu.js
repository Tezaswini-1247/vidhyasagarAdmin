      ...
      [
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-ygBJNX8K.js")),
        ...
        },
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-BL-S3xSs.js")),
        ...
        },
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-CWMkheDn.js")).then((mod) => ({
        ...
        },
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-Cl_7ja60.js")).then((mod) => ({
...
exports.index = index;
//# sourceMappingURL=index-5-6-poLu.js.map
