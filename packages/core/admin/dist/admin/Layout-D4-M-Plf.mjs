...
import { p as SETTINGS_LINKS_CE, b as Layouts } from './index-DdAmwxFa.mjs';
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import('./index-DdAmwxFa.mjs').then(n => n.K)).SETTINGS_LINKS_EE(),
    {
...
export { Layout };
//# sourceMappingURL=Layout-D4-M-Plf.mjs.map
