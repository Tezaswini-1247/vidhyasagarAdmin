...
const en = {
	...
	"Auth.form.button.login.strapi": "Log in via AI4Mahila",
	...
	"Auth.form.register.subtitle": "Credentials are only used to authenticate in AI4Mahila. All saved data will be stored in your database.",
	"Auth.form.rememberMe.label": "Remember me",
	"Auth.form.username.label": "Username",
	"Auth.form.username.placeholder": "e.g. Kai_Doe",
	"Auth.form.welcome.subtitle": "Log in to your AI4Mahila account",
	"Auth.form.welcome.title": "Welcome to AI4Mahila!",
	...
	"HomePage.welcome.congrats.content": "You are logged in as the first administrator. To discover the powerful features provided by AI4Mahila,",
	...
	"Settings.application.ee.admin-seats.add-seats": "{isHostedOnAI4MahilaCloud, select, true {Add seats} other {Contact sales}}",
	...
	"Settings.application.strapi-version": "AI4Mahila version",
	"Settings.application.strapiVersion": "AI4Mahila version",
	...
	"Settings.permissions.users.listview.header.subtitle": "All the users who have access to the AI4Mahila admin panel",
	...
	"admin.pages.MarketPlacePage.offline.subtitle": "You need to be connected to the Internet to access AI4Mahila Market.",
	...
	"admin.pages.MarketPlacePage.plugin.tooltip.madeByStrapi": "Made by AI4Mahila",
	"admin.pages.MarketPlacePage.plugin.tooltip.verified": "Plugin verified by Strapi",
	"admin.pages.MarketPlacePage.plugin.version": "Update your AI4Mahila version: \"{AI4Mahila}\" to: \"{versionRange}\"",
	"admin.pages.MarketPlacePage.plugin.version.null": "Unable to verify compatibility with your AI4Mahila version: \"{AI4Mahila}\"",
	...
	"admin.pages.MarketPlacePage.subtitle": "Get more out of AI4Mahila",
	"admin.pages.MarketPlacePage.tab-group.label": "Plugins and Providers for AI4Mahila",
	...
	"app.components.BlockLink.blog.content": "Read the latest news about AI4Mahila and the ecosystem.",
	"app.components.BlockLink.cloud": "Strapi Cloud",
	"app.components.BlockLink.cloud.content": "Fully-managed cloud hosting for your AI4Mahila project.",
	...
	"app.components.BlockLink.tutorial.content": "Follow step-by-step instructions to use and customize AI4Mahila.",
	...
	"app.components.HomePage.welcomeBlock.content": "Congrats! You are logged as the first administrator. To discover the powerful features provided by AI4Mahila, we recommend you to create your first Content type!",
	"app.components.HomePage.welcomeBlock.content.again": "We hope you are making progress on your project! Feel free to read the latest news about AI4Mahila. We are giving our best to improve the product based on your feedback.",
	...
	"app.components.LeftMenu.navbrand.title": "AI4Mahila Dashboard",
	...
	"app.components.MarketplaceBanner": "Discover plugins built by the community, and many more awesome things to kickstart your project, on AI4Mahila Marketplace.",
	"app.components.MarketplaceBanner.image.alt": "A AI4Mahila rocket logo",
	...
	"app.components.NpsSurvey.banner-title": "How likely are you to recommend AI4Mahila to a friend or colleague?",
	...
	"components.AutoReloadBlocker.description": "Run AI4Mahila with one of the following commands:",
	...
	"global.plugins.sentry.description": "Send AI4Mahila error events to Sentry.",
	...
	"notification.ee.warning.over-.message": "Add seats to {licenseLimitStatus, select, OVER_LIMIT {invite} AT_LIMIT {re-enable}} Users. If you already did it but it's not reflected in AI4Mahila yet, make sure to restart your app.",
	...
	"notification.version.update.message": "A new version of AI4Mahila is available!",
...
//# sourceMappingURL=en-BXrZ-rxH.mjs.map
