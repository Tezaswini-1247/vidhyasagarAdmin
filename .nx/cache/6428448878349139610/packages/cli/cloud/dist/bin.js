...
function loadStrapiCloudCommand(argv = process.argv, command2 = new commander.Command()) {
  ...
  buildStrapiCloudCommands({ command: command2, ctx, argv });
}
function runStrapiCloudCommand(argv = process.argv, command2 = new commander.Command()) {
  loadStrapiCloudCommand(argv, command2);
  command2.parse(argv);
}
